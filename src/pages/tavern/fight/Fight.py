...
def Fight(screen, mainClock, hero, bot):
    ...
    battle_results = Battle.hero_vs_bot(hero, bot);
    ...
    attacker = {
        "id": hero.hero_id,
        "name": hero.name,
        "fight_class": str(hero.fight_class).lower(),
        "avatarID": hero.avatar_id,
        "max_health": hero.get_statistics().hp,
        "current_health": hero.get_statistics().hp,
    }

    defender = {
        "id": bot.name,
        "name": bot.name,
        "fight_class": str(bot.fight_class).lower(),
        "avatarID": bot.image_id,
        "max_health": bot.get_statistics().hp,
        "current_health": bot.get_statistics().hp,
    }
    ...
    stat_headers, stat_values = generatePreview(hero, bot,
